...
const (
	...
	PURCHASING_PRODUCT_STATUS_NO_FINAL = 2
	PURCHASING_PRODUCT_STATUS_FINAL    = 3

	PURCHASING_PAY_STATUS_NO_FINAL = 2
	PURCHASING_PAY_STATUS_FINAL    = 3

	PURCHASING_INVOICE_STATUS_NO_FINAL = 2
	PURCHASING_INVOICE_STATUS_FINAL    = 3
